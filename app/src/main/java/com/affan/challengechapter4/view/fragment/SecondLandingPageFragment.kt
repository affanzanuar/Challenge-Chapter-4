 ...
 * Use the [SecondLandingPageFragment.newInstance] factory method to
...
class SecondLandingPageFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SecondLandingPageFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SecondLandingPageFragment().apply {
