 ...
 * Use the [ThirdLandingPageFragment.newInstance] factory method to
...
class ThirdLandingPageFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ThirdLandingPageFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ThirdLandingPageFragment().apply {
